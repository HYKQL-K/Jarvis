...
// Placeholder MediaPipe Hands bridge. Replace detection logic with actual MediaPipe plugin calls.
public sealed class HandTracker : MonoBehaviour
{
    ...
    private void Update()
    {
        // In a real implementation, populate _hands from MediaPipe Hands.
        if (_hands.Count > 0)
        {
    ...
    // Allow tests or simulated input to provide landmarks (21 per hand).
